...
class WaybackClient(_utils.DepthCountedContext):
    ...
    def search(self, url, *, matchType=None, limit=None, offset=None,
               ...
               skip_malformed_results=True, previous_result=None, calls_per_second=None, **kwargs):
        """
        ...
        * https://github.com/internetarchive/wayback/tree/master/wayback-cdx-server
        ...
        with _utils.rate_limited(calls_per_second=calls_per_second if calls_per_second is not None else
                                 self.session.search_calls_per_second, group='search'):
    ...
    def get_memento(self, url, datetime=None, mode=Mode.original, *,
        ...
        with _utils.rate_limited(calls_per_second=calls_per_second if calls_per_second is not None else
                                 self.session.memento_calls_per_second, group='get_memento'):
